...
echo '<div align="center">
	<table border="0" style="border-collapse: collapse" cellspacing="4" cellpadding="2" bgcolor="#E8E8E8">
		<tr>
			...
			<td bgcolor="#000000"><b><font color="#FFFFFF">Izmçrs</font></b></td>
			<td bgcolor="#000000"><b><font color="#FFFFFF">Iespçjas</font></b></td>
		</tr>';
...
echo '<form method="POST" action="?p=jaunumi&p2=edit2&id='.$id.'">
	<div align="center">
		<table border="0" style="border-collapse: collapse; background-color:#E8E8E8">
			<tr>
				<td class="mcheader" align="right" colspan="2">
				<p align="left">Rediìç jaunumus!</td>
			</tr>
			<tr>
				<td align="right"><b>Virsraksts:</b></td>
			...
			<tr>
				<td colspan="2"><input type="submit" value="Rediìçt"></td>
				</td>
			</tr>
			</table>
...
case 'edit2':
  $datums=date("d.m.Y");
  $ko_arr=array($_POST['1'], $_POST['2'], $_SESSION['autors'], $datums.' rediìçts', $_POST['5']);
  include $DB;
...
show_record($DB, 'visus', 'reversais', 15, $template);
/*
Ðeit arhîva funkcija, kas sasorte pa gadiem menesiem un datumiem...
